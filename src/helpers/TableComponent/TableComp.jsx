    ...
    return (
      <div className="VendorDetailsDiv">
          <div className="tableWrapper">
            ...
            >
              <EnhancedTableHead
                ...
                // subheading={this.props.subheding}
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className={`${this.props.tableicon_align}`}>
                          ...
                          <CloseIcon className="tabledelete_icon" onClick={() => this.handleClickOpen("delete_profile","Delete Media")}/>}
        ...
        <Modalcomp  visible={this.state.view} title={this.state.title} closemodal={this.closemodal} xswidth={"xs"}>
          {this.state.type === "delete_profile" && <DeleteMedia closemodal={this.closemodal}/> }
           </Modalcomp> 
