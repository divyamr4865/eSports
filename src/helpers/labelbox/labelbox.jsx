	...
	renderinput=(data)=>{
		...
		return(
			<div className="formdiv">
				...
				<div>
				<input className="brdrcls" value={this.props.value} placeholder={this.props.placeholder}  maxLength={this.props.maxlength} type="text" onChange={(e)=>this.props.changeData&&this.props.changeData(e.target.value)} />
				{
    	data.error&&
